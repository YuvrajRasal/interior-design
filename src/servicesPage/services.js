...
import GatewayContact from "../components/gatewayContact/GatewayContact";
  ...
  return (
    <div className="services">
      ...
      <div className="howWeWork">
        ...
        <div className="hc-subtext-small">
          <h2>Concept & Details</h2>
          <p>
            It is a long established fact will be distracted. Lorem Ipsum is
            simply dummy from text of the and typesetting indufstry.{" "}
        ...
        <div className="hc-subtext-small">
          <h2>Idea for work</h2>
          <p>
            Hello It is a long established fact will be distracted. Lorem Ipsum
